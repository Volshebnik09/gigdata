      ...
      table: {
        ...
        body: [
          ...
          [
            "data.fias_level",
            {
              title: "Уровень детализации, до которого адрес найден в ФИАС (ГАР):",
              caption: "  0 — страна\n" +
                "  1 — регион\n" +
                "  3 — район\n" +
                "  4 — город\n" +
